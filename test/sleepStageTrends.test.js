...
test('sleep-stage day mode returns seven daily stacked values', () => {
  ...
  assert.equal(shiftSleepStageAnchor('2026-07-03', 'day', -1, 7), '2026-06-26');
});

test('sleep-stage week and month modes use four- and three-period defaults', () => {
  ...
  assert.equal(weeks.points.length, 4);
